...
const BottomTab = () => {
  return (
    <Tab.Navigator initialRouteName='StackHome' barStyle={{ backgroundColor: COLORS.transparent }} theme={{ colors: { background: 'red' } }} shifting activeColor={COLORS.dark} inactiveColor={COLORS.gray} screenOptions={({ route }: any) => configTab(route)}>
      {
