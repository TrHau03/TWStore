...
type navigationProps = StackNavigationProp<RootStackParamList, RootStackScreenEnum.SlideScreen>
...
const SlideScreen = (props: any) => {
    ...
    return (
        <Animated.View style={{ padding: 20, width: '100%', height: '100%' }}>
            ...
            <View style={{ marginTop: 80 }}>
                <TouchableOpacity style={styles.nextBTN} onPress={() => { step < 3 ? setStep(step + 1) : navigation.navigate(RootStackScreenEnum.LoginSreen) }}>
