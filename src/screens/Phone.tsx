        ...
        <View style={styles.container}>
            ...
            <View style={styles.Email}>
                ...
                <View style={styles.input}>
                    <Image source={require('../asset/image/Phone_Profile.png')} style={{alignSelf:'center'}}/>
                    <TextInput style={styles.txtInput} keyboardType='name-phone-pad' placeholder="0372711935" />
                </View>
            </View>
