...
const Home = () => {
  ...
  const data2 = [
    { id: '1', name: 'FS - Nike Air Max 270 React...', image: require('../asset/img/giay.png') },
    { id: '2', name: 'FE - QUILTED MAXI CROS...', image: require('../asset/img/giay.png') },
    { id: '3', name: 'FA - Nike Air Max 350 React...', image: require('../asset/img/giay.png') },
  ];
  ...
  return (
    <ScrollView>
      ...
      <Image style={styles.imgrecomended} source={require('../asset/img/r.png')} />
